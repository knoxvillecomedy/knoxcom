        ...
        <div className="mt-20 pt-16 relative">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 rounded-xl bg-gradient-to-br from-accent/5 to-transparent p-6 border-l-4 border-accent/60">
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-3 hover:translate-x-1 transition-transform duration-200">
                    <span className="w-2 h-2 rounded-full bg-accent mt-2 flex-shrink-0 ring-1 ring-accent/40 ring-offset-2 ring-offset-transparent" />
