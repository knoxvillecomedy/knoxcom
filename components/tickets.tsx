    ...
    <section id="tickets" className="py-12 md:py-20 px-4 bg-background relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
          Join us for Knoxville&apos;s inaugural comedy festival.
        </p>
        ...
        <p className="text-sm flex items-center justify-center gap-2 mb-8" style={{ color: '#ff7e00' }}>
          Now with 68% lower fees via Tixtree.com!
        </p>
